...
guui.add(scene, 'backgroundBlurriness').min(0).max(1).step(0.001)
guui.add(scene, 'backgroundIntensity').min(0).max(10).step(0.001)
guui.add(scene.backgroundRotation, 'y').min(0).max(Math.PI * 2).step(0.001).name('backgroundRotationY')
guui.add(scene.environmentRotation, 'y').min(0).max(Math.PI * 2).step(0.001).name('environmentRotationY')
...
const holyDonut =  new THREE.Mesh(
    new THREE.TorusGeometry(8, 0.55),
